...
var PokevisUI = (function() {
	...
	*/
	...
	check boxes.
	*/
	var getCheckedBox = function(boxes) {
		var retlist = [];
	...
	*/
	var checkAllBox = function(boxes) {
		for (var i = 0, length = boxes.length; i < length; i++) {
	...
	*/
	function getCheckedBoxValue(boxes) {
		var retlist = [];
		for (var i = 0, length = boxes.length; i < length; i++) {
			if (boxes[i].checked) {
	...
	*/
	var disableOption = function(generation, radios) {
	...
	return {
		...
		getCheckedBoxValue: getCheckedBoxValue,
